#ifndef __IPHPLATFORM_H__
#define __IPHPLATFORM_H__

#include "../iplatform.h"

class IphPlatform : public IPlatform
{
	private:
	...
	public:
		...
		inline virtual u32 GetCode() const { return PLATFORM_CODE_IPH; }
		inline virtual const char *GetName() const { return "iph"; }
